...
import tpsql.dao.entity.EntityReader;
...
public class Reader {
	...
	public static IPropertyReader<?> objectReader()
	{
		...
		{
			objectReader = (IPropertyReader<?>)SpringContext.instance().get(EntityReader.class);
		}
		return objectReader;
	}
	...
	public static ICollectionReader collectionReader()
	{
		...
		{
			collectionReader = (ICollectionReader)SpringContext.instance().get(DefaultCollectionReader.class);
		}
	...
	static class StringReader implements IPropertyReader<String>
	{
		...
		public String getValue(Object entity, String propertyName, String substitute) {
			String val = getValue(entity,propertyName);
		...
		public String getValue(Object entity, int index, String substitute) {
			String val = getValue(entity,index);
			return val!=null?val:substitute;
		}
	}
	...
	static class IntegerReader implements IPropertyReader<Integer>
	{
		...
		public Integer getValue(Object entity, String propertyName, Integer substitute) {
			Integer val = getValue(entity,propertyName);
			return val!=null?val:substitute;
		}
		...
		public Integer getValue(Object entity, int index, Integer substitute) {
			Integer val = getValue(entity,index);
			return val!=null?val:substitute;
		}
	}
	...
	static class BooleanReader implements IPropertyReader<Boolean>
	{
		...
		public Boolean getValue(Object entity, String propertyName, Boolean substitute) {
			Boolean val = getValue(entity,propertyName);
			return val!=null?val:substitute;
		}
		...
		public Boolean getValue(Object entity, int index, Boolean substitute) {
			Boolean val = getValue(entity,index);
			return val!=null?val:substitute;
		}
