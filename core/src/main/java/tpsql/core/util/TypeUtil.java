...
public class TypeUtil {
			...
			} else
			{
				...
				if (clazz.equals(Integer.class)) {
					if(obj instanceof Number) {
						...
						return (!s.equals("")) ? Integer.parseInt(s) : new Integer(0);
					}
		        }else if(clazz.equals(Long.class)){
					if(obj instanceof Number) {
						return ((Number) obj).longValue();
					} else {
						return (!s.equals("")) ? Long.parseLong(s) : new Long(0);
					}
				}else if (clazz.equals(Float.class)){
		        	if(obj instanceof Number) {
						return ((Number) obj).floatValue();
					} else {
						return (!s.equals("")) ? Float.parseFloat(s) : new Float(0);
					}
		        }else if (clazz.equals(Double.class)){
		        	if(obj instanceof Number) {
						return ((Number) obj).doubleValue();
					} else {
						return (!s.equals("")) ? Double.parseDouble(s) : new Double(0);
					}
	...
	{
		if (String.class.equals(clazz) || Character.class.equals(clazz)) {
			return true;
			...
			return true;
		} else if(clazz.getName().equals("int") || clazz.getName().equals("long") || clazz.getName().equals("boolean") || clazz.getName().equals("double") || clazz.getName().equals("float")) {
			return true;
		}
		return false;
	}
	...
	public static boolean isCollectionType(Class<?> clazz)
	{
		if (List.class.isAssignableFrom(clazz) || Set.class.isAssignableFrom(clazz)) {
			return true;
		} else if(Collection.class.isAssignableFrom(clazz) || Array.class.isAssignableFrom(clazz)) {
			return true;
		} else {
			return false;
		}
	...
	public static class BigDecimalConvert
	{
