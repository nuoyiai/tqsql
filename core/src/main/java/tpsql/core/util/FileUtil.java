...
public class FileUtil {
	...
	{
		return getFilesByPath(filePath,new String[]{fix});
	}

	private static boolean equalFix(String fix1,String fix2){
		return fix1.replace(".", "").equalsIgnoreCase(fix2.replace(".", ""));
	}
     ...
     * @return
     */
    public static String[] getFilesByPath(String filePath, String[] fixs)
    {
	 ...
	 * @return
	 */
	public static String[] getFilesByPath(String[] filePaths, String fix){
		return getFilesByPath(filePaths,new String[]{fix});
	}
     ...
     * @return
     */
    public static String[] getFilesByPath(String[] filePaths, String[] fixs)
    {
        List<String> list = new ArrayList<String>();
    ...
    public static FileInfo[] getAllFileInfosByPath(String[] filePaths, String fix)
    {
        ...
        String[] files = getFilesByPath(filePaths,fix);
        for(String file : files) {
