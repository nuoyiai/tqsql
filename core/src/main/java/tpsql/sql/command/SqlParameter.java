...
public class SqlParameter implements IDbParameter {
	...
	public ValueType parserValueType(Object value){
		...
		else if(value instanceof Byte)return ValueType.Bit;
		else if(value instanceof byte[])return ValueType.Clob;
		else return null;
	}
	...
	public ValueType parserClassType(Class<?> clazz){
		...
		else if(clazz.isAssignableFrom(Byte.class))return ValueType.Bit;
		else if(clazz.isAssignableFrom(Byte[].class))return ValueType.Clob;
		else return null;
	}
