...
public class SqlSelectBuilder {
    ...
    {
        if (StringUtil.isNullOrEmpty(selectCluase)) {
			return null;
		}
        if (!"".equals(this.selectClause))
        {
			...
			this.selectClause = selectCluase;
		}
        return this;
    }
    ...
    {
        if (StringUtil.isNullOrEmpty(orderbyCluase)) {
			return null;
		}
        if (!"".equals(this.orderByClause))
        {
			...
			this.orderByClause = orderbyCluase;
		}
        return this;
    }
    ...
    public String toSqlString()
    {
        ...
        if (StringUtil.isNotEmpty(this.whereClause))
        {
        	sb.append(" WHERE ");
        ...
        if (StringUtil.isNotEmpty(this.groupByClause))
        {
        	sb.append(" GROUP BY ")
                .append(this.groupByClause);
        }
        if (StringUtil.isNotEmpty(this.orderByClause))
        {
            sb.append(" ORDER BY ")
