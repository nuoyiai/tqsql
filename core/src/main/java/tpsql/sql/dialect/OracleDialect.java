...
public class OracleDialect extends AbstractDialect {
	...
	class OracleMeta extends BaseSqlMeta
	{
		...
		{
			return "SELECT T.TNAME AS TABLE_NAME,C.COMMENTS AS TABLE_REMARK FROM TAB T LEFT JOIN USER_TAB_COMMENTS C ON T.TNAME=C.TABLE_NAME WHERE T.TNAME='"+tableName+"'";
		}
