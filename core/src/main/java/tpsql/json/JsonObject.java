...
public class JsonObject extends JsonValue {
    ...
    public void findObject(String key, String value, Consumer<? super JsonObject> action){
    ...
    public void findObject(String selector, Consumer<? super JsonObject> action){
        IJsonFinder jsonFinder = new JsonFinder();
