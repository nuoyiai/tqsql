...
import tpsql.dao.codetable.ICodeTable;
import tpsql.dao.IEntityDao;
import tpsql.dao.entity.EntityUtil;
import tpsql.dao.pagesize.IPageSize;
import tpsql.dao.CodeTableException;
import tpsql.dao.codetable.CodeTable;
...
@Component
public class EntityDao<E> extends DataDao implements IEntityDao<E> {
	private Class<?> clazz;
