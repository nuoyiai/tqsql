...
import tpsql.xml.XmlAttributeCollection;
import tpsql.xml.XmlDocument;
import tpsql.xml.XmlNode;
import tpsql.xml.XmlNodeType;
...
public class SqlMap implements ISqlMap,InitializingBean {
	...
	private SqlItem buildDynamicSqlItem(String sqlString){
		...
		try{xdoc=new XmlDocument("<?xml version=\"1.0\" encoding=\"utf-8\" ?><tptps>"+xml+"</tptps>");}
